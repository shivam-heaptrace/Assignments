...
const EditUserComponent2 = ({ userId, onSwitchToList, onSwitchToAdd }) => {
  //   return (
  //     <>
  //       <div
  //         style={{
  ...
  //         }}
  //       >
  //         <UserListComponent users={users.filter((user) => user.id == userId)}/>
  //       </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <select
                        ...
                        onChange={handleChange}
                      >
                        {/* <option value="">Insert individual user role</option> */}
                  ...
                  <tr>
                    ...
                    <td>
                      <select
                        ...
                        onChange={handleChange}
                      >
                        {/* <option value="">Insert individual user status</option> */}
...
export default EditUserComponent2;
